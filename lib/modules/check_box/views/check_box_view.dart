...
import 'package:form_gyak/modules/check_box/controllers/check_box_view_controller.dart';
          ...
          return Scaffold(
            ...
            body: Column(
              children: [
                ...
                Text("Elvégzet teendök"),
                Align(
                  alignment: Alignment.centerLeft,
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: controller.teljesitettTeendokListalja()),
                ),
              ],
            ),
          );
